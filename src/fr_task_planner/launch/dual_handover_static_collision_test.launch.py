...
def _launch_setup(context, *args, **kwargs):
    ...
    node = Node(
        ...
        executable="dual_handover_static_collision_test",
        name="dual_handover_static_collision_test",
        output="screen",
        emulate_tty=True,
        parameters=params,
    )
    ...
    return [
        LogInfo(
            msg=[
                "DUAL-4B-2 STATIC COLLISION ONLY. "
