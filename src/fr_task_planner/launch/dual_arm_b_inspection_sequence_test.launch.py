...
"""DUAL-5-S: Arm B remaining six-face inspection sequence. PLAN ONLY.
...
def _launch_setup(context, *args, **kwargs):
    ...
    params = [
        ...
        sequence_params,
        {
            ...
            "max_planning_attempts": sequence_params.get("max_planning_attempts", 5),
            "planning_time_sec": sequence_params.get("planning_time_sec", 10.0),
            "max_validation_joint_step": sequence_params.get(
            ...
            "max_plan_ik_per_face": sequence_params.get("max_plan_ik_per_face", 6),
            "roll_coarse_step_deg": sequence_params.get("roll_coarse_step_deg", 30.0),
            "roll_refine_step_deg": sequence_params.get("roll_refine_step_deg", 10.0),
            "preview_yaml": sequence_params.get(
                "preview_yaml", "/tmp/dual5t_preview.yaml"
            ),
        },
    ]
    ...
    node = Node(
        ...
        executable="dual_arm_b_inspection_sequence_test",
        name="dual_arm_b_inspection_sequence_test",
        output="screen",
        emulate_tty=True,
        parameters=params,
    )
    ...
    return [
        LogInfo(
            msg=[
                "DUAL-5-T ARM B ROLL SEARCH AND CORRECTED SIX-FACE SEQUENCE. "
