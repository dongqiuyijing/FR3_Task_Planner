#!/usr/bin/env python3
"""Open DUAL-8-HOME preview RViz. Does not start bringup or send motion."""
...
def _fetch_descriptions():
    rclpy.init()
    node = rclpy.create_node("dual8_rviz_param_fetch")
...
def _setup(context, *args, **kwargs):
    ...
    return [
        LogInfo(msg="DUAL-8-HOME RViz preview window. MODEL PREVIEW ONLY. Not executable."),
        Node(
            package="rviz2",
            executable="rviz2",
            name="dual8_home_rviz",
            output="screen",
