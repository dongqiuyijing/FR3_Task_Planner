...
def _launch_nodes(context, *args, **kwargs):
    """Reuse Stage4 YAML geometry and start the plan-only attach/lift node."""
    ...
    return [
        ...
        Node(
            ...
            executable="fr3_mtc_attach_lift_test",
            name="fr3_mtc_attach_lift_test",
            output="screen",
